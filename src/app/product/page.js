        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-x-6 gap-y-12 sm:grid-cols-2 lg:grid-cols-3">
            {products.map((product, index) => (
              ...
              >
                <div className="group">
                  <div className="relative aspect-[4/5] overflow-hidden rounded-[30px] bg-white">
                    <Image
                      src={product.image}
                      alt={product.name}
                      fill
                  ...
                  <div className="pt-5">
                    <h2 className="text-xl font-medium text-[#493B08]">
                      {product.name}
                    </h2>
      ...
      <section className="px-5 pb-20 sm:px-8">
        <Reveal direction="up">
          <div className="mx-auto max-w-6xl rounded-[35px] bg-[#FFD923] p-10 text-center sm:p-16">
            ...
            <Link
              href="/ingredients"
              className="mt-7 inline-block rounded-full bg-[#493B08] px-7 py-3.5 text-sm text-white"
            >
